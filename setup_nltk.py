"""
Script to handle NLTK data downloads for the ReturnX project.
Ensures necessary resources are available for text preprocessing.
Mainly used to ensure NLTK data is available in the Render environment for deployment.
"""
