...
# Poison phrases to remove (from notebook lines 356-365)
...
# Individual positive sentiment words to remove (from notebook lines 368-371)
INDIVIDUAL_STOP_WORDS: list[str] = [
    "love", "great", "perfect", "cute", "recommend", "compliments", "comfortable",
    "want", "wanted", "feel", "like", "nice", "good"
]

# Negations to KEEP - don't remove these (from notebook line 375)
...
def clean_review_text(text: str) -> str:
    ...
    words_cleaned = [word for word in words if (word not in final_stop_words) or (word in NEGATIONS)]
